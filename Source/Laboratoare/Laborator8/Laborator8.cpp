...
void Laborator8::OnInputUpdate(float deltaTime, int mods)
{
	...
	if (!window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
	{
		...
		rotation = glm::rotate(rotation, RADIANS(y), glm::vec3(1, 0, 0));
		rotation = glm::rotate(rotation, RADIANS(x), glm::vec3(0, 0, 1));
